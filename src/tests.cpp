...
PiecesSet generateTestPuzzles()
{
    ...
    p1.parts.push_back(VolPart(VolPart::VolType::Angle, Vector(0, 1, 0), Vector(0, 1, -1)));
    ...
    p2.parts.push_back(VolPart(VolPart::VolType::Angle, Vector(0, 1, 1), Vector(-1, 0, 1)));
    ...
    p3.parts.push_back(VolPart(VolPart::VolType::Angle, Vector(0, 1, 0), Vector(1, 1, 0)));
    p3.parts.push_back(VolPart(VolPart::VolType::Angle, Vector(1, 0, 1), Vector(1, 0, -1)));
...
bool makeGeneralTests()
{
    ...
    p1.parts.push_back(VolPart(VolPart::VolType::Angle, Vector(0, 0, 0), Vector(1, 0, -1)));
    p1.parts.push_back(VolPart(VolPart::VolType::Angle, Vector(0, 1, 1), Vector(0, 1, 1)));
