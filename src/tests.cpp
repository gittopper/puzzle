...
PiecesSet generateTestPuzzles()
{
  ...
  p1.parts.push_back(VolPart(VolPart::Angle, Vector(0, 1, 0), Vector(0, 1, -1)));
  ...
  p2.parts.push_back(VolPart(VolPart::Full, Vector(0, 0, 1)));
  p2.parts.push_back(VolPart(VolPart::Angle, Vector(0, 1, 1), Vector(-1, 0, 1)));
  pieces.pieces.push_back(p2);


  Piece p3(3);
  p3.parts.push_back(VolPart(VolPart::Full, Vector(0, 0, 0)));
  p3.parts.push_back(VolPart(VolPart::Full, Vector(0, 0, 1)));
  p3.parts.push_back(VolPart(VolPart::Angle, Vector(0, 1, 0), Vector(1, 1, 0)));
  p3.parts.push_back(VolPart(VolPart::Angle, Vector(1, 0, 1), Vector(1, 0, -1)));
...
bool makeGeneralTests()
{
  ...
  BREAK_ON_LINE(Vector(0, 0, 1).rotate(RotateX).rotate(RotateX) == Vector(0, 0, -1));

  BREAK_ON_LINE(Vector(1, 0, 0).rotate(RotateY) == Vector(0, 0, 1));
  BREAK_ON_LINE(Vector(1, 0, 0).rotate(RotateY).rotate(RotateY) == Vector(-1, 0, 0));

  BREAK_ON_LINE(Vector(0, 1, 0).rotate(RotateZ) == Vector(1, 0, 0));
  BREAK_ON_LINE(Vector(0, 1, 0).rotate(RotateZ).rotate(RotateZ) == Vector(0, -1, 0));
  ...
  Piece p1(1);
  p1.parts.push_back(VolPart(VolPart::Full, Vector(0, 0, 1)));
  p1.parts.push_back(VolPart(VolPart::Full, Vector(0, 1, 0)));
  p1.parts.push_back(VolPart(VolPart::Angle, Vector(0, 0, 0), Vector(1, 0, -1)));
  p1.parts.push_back(VolPart(VolPart::Angle, Vector(0, 1, 1), Vector(0, 1, 1)));
