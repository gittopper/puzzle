...
void GLRenderer::drawSquare(const Geometry::Vector& shift,
...
void GLRenderer::drawTriangle(const Geometry::Vector& shift,
                              const Geometry::Vector& v1,
                              const Geometry::Vector& v2,
                              const Geometry::Vector& v3,
                              const Geometry::Vector& n) const {
...
void GLRenderer::setColor(const Geometry::Vector& color) const {
